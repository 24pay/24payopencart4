<?php
namespace Opencart\Admin\Controller\Extension\Twentyfourpay\Payment;
class Twentyfourpay extends \Opencart\System\Engine\Controller {
  private $error = [];
...
public function index() : void  {
    ...
    $data['breadcrumbs'][] = [
        ...
        'href'      => $this->url->link('extension/twentyfourpay/payment/twentyfourpay', 'user_token=' . $this->session->data['user_token']),
        'separator' => ' :: '
    ];

    $data['action'] = $this->url->link('extension/twentyfourpay/payment/twentyfourpay', 'user_token=' . $this->session->data['user_token']);

    $data['action_call'] = $this->url->link('extension/twentyfourpay/payment/twentyfourpay|call', 'user_token=' . $this->session->data['user_token']);
    ...
    $this->response->setOutput($this->load->view('extension/twentyfourpay/payment/twentyfourpay', $data));
  }

  private function validate() {
    if (!$this->user->hasPermission('modify', 'extension/twentyfourpay/payment/twentyfourpay')) {
