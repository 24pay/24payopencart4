<?php
namespace Opencart\Catalog\Controller\Extension\Twentyfourpay\Payment;
class Twentyfourpay extends \Opencart\System\Engine\Controller {

  public function index() :string {
    $this->language->load('extension/twentyfourpay/payment/twentyfourpay');
  ...
  private function generateData(){
    ...
    $setting_array = array (
      'rurl'      =>  $this->url->link('extension/twentyfourpay/payment/twentyfourpay|rurl', '', 'SSL'),
      'nurl'      =>  $this->url->link('extension/twentyfourpay/payment/twentyfourpay', '', 'SSL'),
